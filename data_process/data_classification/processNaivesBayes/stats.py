...
def stats1(X, Y, nb_split_kfold):
    ...
    for i in sizeData :
        ...
        for depth in range(3, 20) :
            ...
            kfold = KFold(n_splits=nb_split_kfold, shuffle=True)
            accuracy = 0
            ...
            for train, test in kfold.split(X_train) :
                ...
                # Fitting the model with the training data of X and Y
                naives_bayes.fit(X_trainK, Y_trainK)

                # predictions on validation/test set
                y_pred_en = naives_bayes.predict(x_testK)
            ...
            average_accuracy = accuracy / nb_split_kfold
            average_accuracies.append(average_accuracy)
            # print("Average Accuracy for the  is ", average_accuracy)
        frame2 = pd.DataFrame({'max_depth' : range(3, 20), 'average_acc' : average_accuracies})
    ...
    for i in axes :
        ...
        i.set_xlabel("Iteration", fontsize='11')
